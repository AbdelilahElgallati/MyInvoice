...
const Header = () => {
  ...
  // Appeler la fonction pour récupérer et afficher la traduction
 

 
// const translateText = async () => {
//   try {
//     const response = await axios.get(`https://api.mymemory.translated.net/get?q=${text}&langpair=${From}|${To}`);

...
//               <div className='dark:text-white mb-3 text-[30px] font-medium font-Quicksand font-semibold'>
//                 {title}
//               </div>
//               <div className='dark:text-white mb-6 text-light font-Quicksand font-medium'>{subtitle}</div>
//               {index === cardIndex && <img src={ArrowImg} alt='arrow' />}
        ...
        return (
          <div key={cardIndex} data-aos='zoom-out' data-aos-offset='300' data-aos-delay={delay}>
            <div
              onClick={() => setIndex(cardIndex)}
              className={`${
                index === cardIndex && 'dark:bg-gray-800 bg-white shadow-2xl'

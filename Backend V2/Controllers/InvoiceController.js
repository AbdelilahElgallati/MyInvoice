...
const getDashboardStats = async (req, res) => {
  try {
    ...
    const totalUnpaidInvoices = await Invoice.countDocuments({ status: { $nin: ["paid"] } });
    /* Overall Stats */
...
module.exports = {addInvoice,getAllInvoices,getOneInvoice,updateInvoice,removeInvoice,getSales,getDashboardStats};